          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center sm:justify-center items-center gap-y-2 gap-x-4 text-center sm:text-left">
            ...
            <form onSubmit={handleSubmit} className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-4 py-1.5 bg-purple-600 hover:bg-purple-700 dark:bg-purple-500 dark:hover:bg-purple-600 text-gray-800 dark:text-white font-medium rounded-full text-sm transition disabled:opacity-50 whitespace-nowrap"
              >
