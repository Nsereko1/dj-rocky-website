            ...
            <div className="space-y-6">
              ...
              <div className="space-y-5 text-gray-700 dark:text-gray-300 leading-relaxed text-base sm:text-lg">
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <a href="https://open.spotify.com/artist/0G55Xq51I94cNd8Qw1zY7R" className="border-2 border-purple-600 text-purple-600 dark:text-purple-400 hover:bg-purple-600 hover:text-white font-bold py-3 px-6 rounded-full transition inline-block">
                    Listen on Spotify
                  </a>
                </div>
              </div>
