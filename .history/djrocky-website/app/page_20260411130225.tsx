      ...
      <nav className="fixed top-0 left-0 right-0 bg-white/5 dark:bg-black/5 backdrop-blur-md z-50 border-b border-white/10 dark:border-white/5">
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            {/* Left Side - DJ Rocky with Dropdown */}
            <div className="flex items-center gap-2">
              <div className="relative group">
                <button className="flex items-center gap-1 text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300 transition font-medium text-lg">
                  DJ ROCKY <span className="text-sm">▼</span>
                </button>
                <div className="absolute left-0 mt-2 w-48 bg-white/95 dark:bg-black/95 backdrop-blur-md border border-gray-200 dark:border-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <DropdownItem onClick={() => setShowBio(false)}>Home</DropdownItem>
            ...
            <div className="text-gray-900 dark:text-white text-sm sm:text-base">
              <span className="hidden sm:inline">📞 (256) 703-587550</span>
