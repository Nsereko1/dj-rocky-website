...
import MusicSection from "@/app/components/ui/MusicSection";
import VideoSection from "@/app/components/ui/VideoSection";
import GallerySection from "@/app/components/ui/GallerySection";
import TourSection from "@/app/components/ui/TourSection";
import BioSection from "@/app/components/ui/BioSection";


// Main content that uses searchParams – wrapped in Suspense
function HomeContent() {
  ...
  // Sync URL param with state on initial load and when param changes
  useEffect(() => {
