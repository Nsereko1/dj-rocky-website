...
export default function Home() {
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white/90 dark:bg-black/90 backdrop-blur z-50 border-b border-gray-200 dark:border-white/10">
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">DJ ROCKY</h1>
      ...
      {/* Footer */}
      <footer className="bg-gray-50 dark:bg-black text-gray-600 dark:text-white/70 py-8 text-sm border-t border-gray-200 dark:border-white/10">
