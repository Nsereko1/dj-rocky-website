...
export default function Home() {
  ...
  // Tour images with dynamic sizing - using next/image with unoptimized to maintain original ratios
  const tourImages = [
    { src: "/tour/HCvocixXsAAwGHR.jpeg", alt: "Tour 1" },
    { src: "/tour/G5AvVFIXEAAx2Ss.jpeg", alt: "Tour 2" },
    { src: "/tour/G5-T6EMXkAAIwIM.jpeg", alt: "Tour 3" }
  ];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-48 bg-white/95 dark:bg-black/95 backdrop-blur-md border border-gray-200 dark:border-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <DropdownItem onClick={() => setShowMusic(true)}>Music</DropdownItem>
                <DropdownItem onClick={() => setShowVideo(true)}>Videos</DropdownItem>
                <DropdownItem onClick={() => setShowGallery(true)}>Gallery</DropdownItem>
                <DropdownItem href="#">Shop</DropdownItem>
                <DropdownItem onClick={() => setShowTour(true)}>Tour</DropdownItem>
            ...
            {/* Empty div for spacing to keep center alignment */}
      ...
      {/* Main Content */}
      {!showBio && !showVideo && !showGallery && !showTour && !showMusic ? (
        // Hero Image
            ...
            <div className="bg-gray-100 dark:bg-gray-900/50 p-6 rounded-xl">
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-700 dark:text-gray-300 font-bold">
                  Stream the latest album from DJ Rocky
                </p>
                <a 
                  href="https://open.spotify.com/album/3ixKIxWyPdu5oocj3n5NID" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block mt-4 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-full transition transform hover:scale-105"
                >
                  Open in Spotify App 🎵
                </a>
              </div>
        ...
        // Tour Section - Dynamic image ratios
        <div className="pt-24 sm:pt-28 pb-16 px-4 sm:px-6 lg:px-8 min-h-screen bg-white dark:bg-black">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-8 text-center">Tour</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {tourImages.map((img, index) => (
                <div key={index} className="rounded-xl overflow-hidden shadow-lg bg-gray-100 dark:bg-gray-900 hover:shadow-2xl transition-shadow duration-300">
