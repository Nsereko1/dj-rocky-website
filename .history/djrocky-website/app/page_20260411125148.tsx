              ...
              <div className="space-y-5 text-gray-700 dark:text-gray-300 leading-relaxed text-base sm:text-lg">
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 rounded-xl">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    ...
                    <span className="font-semibold">📞 Tyla (917) 920-2019</span><br />
                    <span className="font-semibold">✉️ booking@djrockyworld.com</span>
                  </p>
                </div>
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <a href="#" className="border-2 border-purple-600 text-purple-600 dark:text-purple-400 hover:bg-purple-600 hover:text-white font-bold py-3 px-6 rounded-full transition inline-block">
                    Listen on Spotify
                  </a>
                </div>
              </div>
