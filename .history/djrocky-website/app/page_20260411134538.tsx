...
export default function Home() {
  ...
  // Tour images - will maintain original aspect ratios
  const tourImages = [
    { src: "/tour/HCvocixXsAAwGHR.jpeg", alt: "DJ Rocky Live Performance" },
    { src: "/tour/G5AvVFIXEAAx2Ss.jpeg", alt: "DJ Rocky on Stage" },
    { src: "/tour/G5-T6EMXkAAIwIM.jpeg", alt: "DJ Rocky Tour" }
  ];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      {!activeSection ? (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-100 dark:bg-gray-900/50 p-6 rounded-xl">
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-700 dark:text-gray-300 font-bold">Stream the latest album from DJ Rocky</p>
                <a 
        ...
        // Tour Section - Dynamic image sizes (preserves original aspect ratio)
        <div className="pt-24 sm:pt-28 pb-16 px-4 sm:px-6 lg:px-8 min-h-screen bg-white dark:bg-black">
          <div className="max-w-6xl mx-auto">
        ...
        // Bio Section
        <div className="pt-24 sm:pt-28 pb-16 px-4 sm:px-6 lg:px-8 min-h-screen bg-white dark:bg-black">
          {/* Your existing Bio content remains unchanged */}
          <div className="max-w-4xl mx-auto">
            <div className="space-y-6">
              ...
              <div className="space-y-5 text-gray-700 dark:text-gray-300 leading-relaxed text-base sm:text-lg">
                <p className="font-bold">
                  <span className="font-bold text-gray-900 dark:text-white">Busuulwa Peter Nsereko</span>, professionally known as <span className="font-bold text-gray-800 dark:text-gray-400">DJ Rocky</span>, is a Ugandan DJ, Producer, Software Engineer, Entrepreneur & Philanthropist. ...
                </p>
                {/* Add the rest of your bio content here if needed */}
              </div>
            </div>
          </div>
        </div>
