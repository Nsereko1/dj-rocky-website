        ...
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="relative group">
              <button className="flex items-center gap-1 text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300 transition font-medium text-lg">
            ...
            <button 
              ...
              className="text-2xl sm:text-4xl font-bold text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300 transition"
            >
              DJ ROCKY
            </button>
            ...
            <div className="hidden md:block text-gray-900 dark:text-white text-sm">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-x-3 gap-y-2 text-center">
              ...
              <a href="#" className="hover:text-gray-900 dark:hover:text-white transition">Your Global Privacy Rights</a>
              <span className="hidden xs:inline">|</span>
...
function DropdownItem({ href, children, onClick }: { href?: string; children: React.ReactNode; onClick?: () => void }) {
  ...
  return (
    <a
      href={href}
      className="block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white transition first:rounded-t-lg last:rounded-b-lg"
    >
      {children}
    </a>
  );
...
function MobileMenuItem({ href, children, onClick }: { href?: string; children: React.ReactNode; onClick?: () => void }) {
  if (onClick) {
    return (
      <button
        onClick={onClick}
        className="w-full text-left py-2 text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300 transition text-lg"
      >
        {children}
      </button>
    );
  ...
  return (
    <a
      href={href}
      className="block py-2 text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300 transition text-lg"
    >
      {children}
    </a>
  );
