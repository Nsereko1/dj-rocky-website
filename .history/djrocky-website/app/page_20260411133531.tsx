...
export default function Home() {
  ...
  // Tour images
  const tourImages = [
    "/tour/HCvocixXsAAwGHR.jpeg",
    "/tour/G5AvVFIXEAAx2Ss.jpeg",
    "/tour/G5-T6EMXkAAIwIM.jpeg"
  ];
      ...
      {!showBio && !showVideo && !showGallery && !showTour && !showMusic ? (
        ...
        <div className="pt-24 sm:pt-28 pb-16 px-4 sm:px-6 lg:px-8 min-h-screen bg-white dark:bg-black">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-8">Music</h1>
            <div className="bg-gray-100 dark:bg-gray-900/50 p-8 rounded-xl">
              <p className="text-gray-700 dark:text-gray-300 mb-6 font-bold">Listen to DJ Rocky's latest album on Spotify</p>
              <a 
        ...
        <div className="pt-24 sm:pt-28 pb-16 px-4 sm:px-6 lg:px-8 min-h-screen bg-white dark:bg-black">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-8 text-center">Tour Dates</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
