...
export const metadata: Metadata = {
  ...
  description: "DJ Rocky - Busuulwa Peter Nsereko, pioneering Future Afro sound. Award-winning Ugandan DJ, producer, software engineer & entrepreneur. Book now for international events, festivals, and exclusive performances. New album 'Afro Evolution' out now.",
