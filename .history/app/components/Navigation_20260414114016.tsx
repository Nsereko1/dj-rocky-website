      ...
      <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="relative" ref={menuRef}>
            ...
            {isMounted && (
              <div 
                className={`absolute left-0 mt-2 w-56 sm:w-48 dark:text-[#929292] bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-lg shadow-xl transition-all duration-200 z-50 ${
