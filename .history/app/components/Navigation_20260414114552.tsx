...
function DropdownItem({ 
  ...
  const activeClasses = isActive 
    ? "bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-[#ffffff] font-semibold" 
    : "text-gray-700 dark:text-[#929292] hover:bg-gray-200 dark:hover:bg-gray-800 active:bg-gray-200 dark:active:bg-gray-800 hover:text-gray-900 dark:hover:text-[#b0b0b0]";
