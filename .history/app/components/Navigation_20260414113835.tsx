        ...
        <div className="flex justify-between items-center">
          ...
          <div className="relative" ref={menuRef}>
            <button
              ...
              className="flex items-center gap-1 text-gray-900 dark:text-[#929292] hover:text-gray-600 dark:hover:text-gray-300 active:text-gray-600 dark:active:text-gray-300 transition font-medium text-lg cursor-pointer touch-manipulation select-none"
