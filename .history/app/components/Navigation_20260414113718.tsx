      ...
      <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex justify-between items-center">
          ...
          <button
            type="button"
            onClick={goHome}
            className="text-xl sm:text-2xl md:text-4xl font-bold text-gray-900 dark:text-[#d0d0d0] hover:text-gray-600 dark:hover:text-gray-300 active:text-gray-600 dark:active:text-gray-300 transition cursor-pointer touch-manipulation select-none"
            aria-label="Home"
            style={{ 
              WebkitTapHighlightColor: 'transparent',
              touchAction: 'manipulation',
